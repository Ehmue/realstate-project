                        ...
                        <div className="product-filter__wrap">
                            ...
                            <div className="search-txt">
                                <select name="selectedservice" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>All Items</option>
                                </select>
                            </div>
                            <div className="search-txt">
                            <select name="selectedregion" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>All Regions</option>
                                </select>
                            </div>
                            <div className="search-txt">
                            <select name="selectedtownship" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>All Townships</option>
                                </select>
                            </div>
                            <div className="search-txt">
                            <select name="selectedtype" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>All Types</option>
                                </select>
                            </div>
                            <div className="search-txt">
                            <select name="selectedpricefrom" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>Price (From)</option>
                                </select>
                            </div>
                            <div className="search-txt">
                            <select name="selectedpriceto" className='selectitem'>
                                    ...
                                    <option value="allitem" selected>Price (To)</option>
                                </select>
                            </div>
